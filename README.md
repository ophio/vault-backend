...
1. Clone this repo to your local development machine.
    ...
    git clone git@github.com:ophio/vault-backend.git && cd vault-backend
...
heroku run python vault-backend/manage.py syncdb --noinput
heroku run python vault-backend/manage.py migrate
heroku run python vault-backend/manage.py createsuperuser
heroku open
```
