...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_project', 'platform',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Platform'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.platform'
        db.delete_column(u'core_project', 'platform_id')
